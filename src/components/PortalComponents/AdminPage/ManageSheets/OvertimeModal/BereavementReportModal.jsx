...
export default function BereavementReportModal({ onClose }) {
  ...
  useEffect(() => {
    async function getTimesheets() {
      const res = await adminCtx.fetchBereavementData(selectedDate);
      setTimesheets(res || []);
    }
    getTimesheets();
    ...
    >
      ...
      >
        <div className="flex justify-between items-center w-full">
          <h1 className="py-3 text-lg">Bi-Weekly Bereavement Report</h1>
          <button
            onClick={downloadCSV}
