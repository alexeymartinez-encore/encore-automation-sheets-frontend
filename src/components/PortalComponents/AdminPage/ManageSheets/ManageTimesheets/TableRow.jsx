...
export default function TableRow({ timesheet, index, onValueChange }) {
  return (
    <div className="grid grid-cols-5 md:grid-cols-9 py-1 px-3 items-center text-[0.6rem] md:text-[0.7rem] rounded-b-md text-center">
      <Link
      ...
      <p className="flex-1 text-left">{timesheet.first_name}</p>
      {/* <p className="flex-1 text-center hidden md:block">{timesheet.message}</p> */}
      <input
