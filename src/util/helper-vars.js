export const phaseToAllowedCostCodes = {
  ...
  200: [100, 200, 300, 500, 700, 825], // Engineering phase ➔ Control Eng / Mech Eng
  300: [300, 400, 425, 475, 900, 925], // Staging / Mod Build ➔ Software-related cost codes
  400: [475, 500], // Install / Commission ➔ Install/Process Prog
  500: [600, 700], // System Debug ➔ Service, Training
  600: [300, 500, 600, 700], // Startup ➔ Service, Training
  700: [700, 800], // Prod Support ➔ Documentation, Admin
  800: [600, 700, 800, 825], // Closeout ➔ Admin, Product Development
